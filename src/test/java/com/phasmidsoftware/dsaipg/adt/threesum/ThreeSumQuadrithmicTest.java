...
public class ThreeSumQuadrithmicTest {
    ...
    public void testGetTriple_ValidTriple() {
        ...
        try (Stopwatch stopwatch = new Stopwatch()) {
            Triple result = threeSum.getTriple(2, 3);
            System.out.println("Execution Time (ValidTriple): " + stopwatch.lap() + " ms");
    ...
    public void testGetTriple_NoTripleExists() {
        ...
        try (Stopwatch stopwatch = new Stopwatch()) {
            Triple result = threeSum.getTriple(0, 1);
            System.out.println("Execution Time (NoTripleExists): " + stopwatch.lap() + " ms");
            assertNull(result);
        }
    }
    ...
    public void testGetTriple_WithNegatives() {
        ...
        try (Stopwatch stopwatch = new Stopwatch()) {
            Triple result = threeSum.getTriple(1, 2);
            System.out.println("Execution Time (WithNegatives): " + stopwatch.lap() + " ms");
            assertNotNull(result);
            assertEquals(0, result.sum());
